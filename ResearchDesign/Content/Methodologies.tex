...
Our main objects and the different technical treatments for the experiment are discussed in section \ref{Objects section}.
We discuss the two phases in section \ref{Research Activities section}, we discuss the results of data collected from the experiment in section \ref{Data Collecting Section}.
...
In the context of this research, the objects of experiment are the ansatz designs. 
