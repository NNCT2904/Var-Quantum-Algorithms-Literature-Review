...
\section{Objects and Parameters}
...
Each of them configures or trains the ansatz in a different way.
...
The output of the first phase is Qiskit ansatz objects that contains the number of qubits, the depth of the circuit (rep), and the parameter configured randomly, please refer to Qiskit document for further detail.
...
Qiskit has offered various of ansatz design, namely \textit{EfficientSU2, PauliTwoDesign, RealAmpplitudes, NLocal}, and \textit{TwoLocal}. They are popular and frequently studied in quantum chemistry, quantum machine learning, especially the investigation in Barren Plateaus. 
