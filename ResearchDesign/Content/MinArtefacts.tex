...
\almarginpar{Remember that this text is to explain the research design and what is to be done, not what was done!}
...
\almarginpar{How "practicality" comes out of your work?}We believe that the result of this project would help VQAs and QNNs can solve more practical problems. 
\almarginpar{"machine learning and computer scientists" are apples and oranges, also the statement is a motherhood statement - avoid it}This project also gives an introduction to quantum technologies for machine learning and computer scientists.
