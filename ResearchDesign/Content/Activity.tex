...
According to the \almarginpar{Where exactly exploratory research is described in this book? Provide ref to section or page numbers. If you cannot find perhaps use their term "quasi-experiments", or try this paper: Software Engineering Research Strategy: Combining Experimental and Explorative Research \\ - I've changed the reference}\emph{exploratory experiment guidelines} \cite{oivoSoftwareEngineeringResearch2004}, we apply different treatments to the same object.
...
By definition of barren plateau as discussed in Section \ref{Literature Review section}, we would expect the shrinking rate of the variace values to be \textit{exponential} (see Figure \ref{Variance Shrinking demo}) if the initial parameter has landed in a barren plateau.
