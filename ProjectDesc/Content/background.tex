...
\almarginpar{Throughout this document change capitalisation of words such as "Quantum", "Classical", "Machine", "Variational", etc. They do not need to be capped. I gave up fixing these!}
...
\almarginpar{Please ask someone to improve English grammar and expresson}
...
\almarginpar{Will you focus on all types of QNN or just one? \ - we implement a multi-layered Quantum Perceptron as the ansatz}
