...
\begin{figure}
    \centering
    \includegraphics{LiteratureReview/Appendices/lightcone.png}
    \caption{
        The Operator $O_i$ in the topmost is in the scope of the forward light-cone $\mathcal{L}$ of block $W$. The thick-line dashes indicate the backward light-cone $\mathcal{L}$
    }
