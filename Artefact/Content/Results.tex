...
The local cost function - shallow depth ansatz seems to be the best in overcoming barren plateau as discussed in Section \ref{Sec: Sampling Gradients results}, and its accuracy score is indeed better than the unrestricted ansatz.
